        ...
        <section className="bg-gradient-to-r from-[#C70000] to-[#A60000] text-white py-16">
          <div className="max-w-7xl mx-auto px-4 text-center">
            ...
            <p className="text-xl text-red-100 max-w-3xl mx-auto">
              ...
              Get more views, inquiries, and faster sales with the right advertising package.
            </p>
          </div>
        </section>
              ...
              <>
                ...
                <div className="bg-gradient-to-r from-[#C70000] to-[#A60000] rounded-xl text-white p-8">
                  <div className="text-center mb-8">
                    <h2 className="text-2xl font-bold mb-4">Why Choose Our Packages?</h2>
                    <p className="text-red-100">Get the most out of your property listing with our proven advertising solutions</p>
                  </div>
