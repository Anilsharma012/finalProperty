...
const FirebaseAuthTest = () => {
  const { user, firebaseUser, isAuthenticated, loading, logout } = useFirebaseAuth();
              ...
              <CardContent>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-900 font-mono text-sm">{user.firebaseUid || 'Not linked'}</p>
                  </div>
                  <div>
                ...
                {firebaseUser && (
                  <div className="mt-4 pt-4 border-t">
                    <h4 className="font-medium text-gray-900 mb-2">Firebase User Details</h4>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                      <div>
                        <label className="text-sm font-medium text-gray-700">Firebase UID</label>
                        <p className="text-gray-900 font-mono">{firebaseUser.uid}</p>
                      </div>
                      <div>
                        <label className="text-sm font-medium text-gray-700">Provider ID</label>
                        <p className="text-gray-900">{firebaseUser.providerId}</p>
                      </div>
                      <div>
                      ...
                      <div>
                        <label className="text-sm font-medium text-gray-700">Creation Time</label>
                        <p className="text-gray-900">{formatDate(firebaseUser.metadata.creationTime)}</p>
                      </div>
                    </div>
                  </div>
                )}
              ...
              {testMode === 'info' && (
                <Card>
                  ...
                  <CardContent className="space-y-4">
                    <div>
                      <h4 className="font-medium text-gray-900 mb-2">Phone OTP Testing</h4>
                      <ul className="text-sm text-gray-700 space-y-1">
                        <li>• Enter a valid Indian mobile number (10 digits)</li>
                        <li>• Complete the reCAPTCHA verification</li>
                        <li>• Firebase will send a real SMS OTP to your phone</li>
                        <li>• Enter the 6-digit code to complete authentication</li>
                      </ul>
                    </div>

                    <div>
                      <h4 className="font-medium text-gray-900 mb-2">Google Authentication Testing</h4>
                      <ul className="text-sm text-gray-700 space-y-1">
                        <li>• Click the Google sign-in button</li>
                        <li>• A popup will open for Google authentication</li>
                        <li>• Sign in with your Google account</li>
                        <li>• The popup will close and you'll be authenticated</li>
                      </ul>
                    </div>
                    ...
                    <div>
                      ...
                      <ul className="text-sm text-gray-700 space-y-1">
                        ...
                        <li>• Authentication state will persist across page reloads</li>
                        <li>• User will be redirected to appropriate dashboard</li>
