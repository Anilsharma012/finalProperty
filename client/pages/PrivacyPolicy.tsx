...
export default function PrivacyPolicy() {
  useEffect(() => {
    ...
    document.title = "Privacy Policy - Aashish Properties | How We Protect Your Data";
    ...
    if (metaDescription) {
      ...
      meta.content = "Read Aashish Properties privacy policy to understand how we collect, use, and protect your personal information. Your privacy and data security are our priority.";
      ...
      <nav className="bg-white border-b border-gray-200" aria-label="Breadcrumb">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3">
          <div className="flex items-center space-x-2 text-sm text-gray-600">
            ...
            <span>/</span>
            <span className="text-gray-900 font-medium" aria-current="page">Privacy Policy</span>
          </div>
        </div>
      </nav>
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <Alert className="mb-8 border-[#C70000] bg-red-50">
          ...
          <AlertDescription className="text-gray-800">
            <strong>Important:</strong> This privacy policy was last updated on {lastUpdated}. 
            ...
            <div className="grid md:grid-cols-2 gap-2">
              {sections.map((section, index) => (
                <a
                  ...
                  onClick={() => handleFooterLinkClick(`privacy_toc_${section.id}`)}
                >
          ...
          <CardContent className="py-8">
            <div className="text-center">
              ...
              <p className="text-red-100 mb-6 max-w-2xl mx-auto">
                ...
                or would like to exercise your rights, please contact our Privacy Team.
              </p>
                ...
                <div className="space-y-2">
                  <p>
                    ...
                    <a 
                      ...
                      onClick={() => handleFooterLinkClick('privacy_contact_email')}
                    >
                  ...
                  <p>
                    ...
                    <a 
                      ...
                      className="underline hover:no-underline"
                      onClick={() => handleFooterLinkClick('privacy_contact_phone')}
                    >
                      +91 9876543210
                    </a>
                  </p>
        ...
        <div className="mt-8 p-6 bg-gray-100 rounded-lg text-sm text-gray-600">
          <p className="mb-2">
            ...
            and does not constitute legal advice. Laws and regulations may vary by jurisdiction.
          </p>
          <p>
            For the most current version of this privacy policy, please visit our website. 
            This policy is effective as of {effectiveDate} and was last updated on {lastUpdated}.
          </p>
        </div>
        ...
        <div className="mt-8 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <Button variant="outline" asChild onClick={() => handleFooterLinkClick('related_terms')}>
