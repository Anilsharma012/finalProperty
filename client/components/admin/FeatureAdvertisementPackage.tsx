    ...
    try {
      ...
      if (response.ok) {
        ...
        if (data.success) {
          ...
          const featurePackages = data.data.filter((pkg: any) =>
        ...
        setError(`Failed to fetch feature packages: ${response.status} ${response.statusText}`);
      }
    } catch (error) {
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-green-50 border border-green-200 rounded-lg p-4">
              ...
              <p className="text-sm text-green-700">
                Feature Advertisement Packages created here are automatically available on the frontend
                for users to select when posting properties.
              </p>
            </div>
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
              ...
              <p className="text-sm text-blue-700">
                The separate "User Packages" management section has been removed.
                All package management is now handled through this unified system.
              </p>
            </div>
          </div>
          ...
          <div className="mt-4 p-3 bg-gray-50 border border-gray-200 rounded-lg">
            ...
            <ul className="text-sm text-gray-700 space-y-1 list-disc list-inside">
              <li>Admin creates feature packages with specific feature levels (Featured, Premium, Spotlight)</li>
              <li>Packages are instantly available on frontend package selection page</li>
              <li>Users can select packages when posting new properties</li>
              <li>Package features automatically apply to user listings based on selection</li>
              <li>Payment integration handles package purchases and activations</li>
            </ul>
          </div>
        </CardContent>
      </Card>
