  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (ok && data.success) {
        ...
        setError(getApiErrorMessage(data, status, editingCategory ? 'update' : 'create'));
      }
    } catch (error) {
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600">Manage categories for service listings</p>
        </div>
        <Button
      ...
      <div data-testid="service-categories-list" className="space-y-4">
        {categories.map((category) => (
          <Card key={category._id} data-testid={`service-category-${category._id}`}>
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center space-x-2">
                  <Badge className={category.active ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'}>
      ...
      {categories.length === 0 && !loading && (
        <Card>
          <CardContent className="p-12 text-center">
            ...
            <h3 className="text-lg font-medium text-gray-900 mb-2">No service categories yet</h3>
