          ...
          <div className="space-y-4">
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
              ...
              <ul className="text-sm text-blue-700 space-y-1">
                <li>• <strong>categorySlug</strong>: Category identifier (will auto-create if not exists)</li>
                <li>• <strong>subSlug</strong>: Subcategory identifier (will auto-create if not exists)</li>
                ...
                <li>• <strong>lat, lng</strong>: Latitude and longitude coordinates</li>
                <li>• <strong>photo1-4</strong>: Photo URLs (optional)</li>
                <li>• <strong>open, close</strong>: Business hours (HH:MM format)</li>
                <li>• <strong>active</strong>: true/false status</li>
              </ul>
            </div>
          ...
          <CardContent className="p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="bg-green-50 border border-green-200 rounded-lg p-4">
                <h4 className="font-medium text-green-800">Successfully Created</h4>
        ...
        <CardContent>
          <div className="prose prose-sm">
            <ol className="list-decimal list-inside space-y-2 text-gray-600">
              ...
              <li>Fill in your service listing data following the template structure</li>
              <li>Save your file as CSV format</li>
              <li>Upload the CSV file using the upload button above</li>
              <li>Categories and subcategories will be automatically created if they don't exist</li>
