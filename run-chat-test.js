...
async function runChatTest() {
    ...
    try {
        ...
        if (!conversationResponse.ok || conversationResponse.status < 200 || conversationResponse.status >= 300) {
        ...
        if (messageResponse.ok && (messageResponse.status === 200 || messageResponse.status === 201)) {
